json.(@patient, :id, :full_name, :first_name, :last_name, :gender, :birthday, :email, :phone, :age, :insurance, :department, :nationality, :occupation, :company, :created_at, :updated_at, :editor)
