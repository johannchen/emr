angular.module('emrApp').controller 'AllergyCreateCtrl', ['$scope', '$routeParams', '$location', '$sessionStorage', 'Restangular', 'UtilService', ($scope, $routeParams, $location, $sessionStorage, Restangular, UtilService) ->
